...
<style scoped>
/* Ensure video and custom content display correctly in Safari mockup */
foreignObject {
    overflow: hidden;
}

/* Ensure slot content can properly fill the space */
:deep(*) {
