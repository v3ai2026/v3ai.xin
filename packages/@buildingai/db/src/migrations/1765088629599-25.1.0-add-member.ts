...
export class Migration1765088629599 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `DROP TABLE IF EXISTS "extension_feature_membership_levels" CASCADE`,
        );
        await queryRunner.query(`DROP TABLE IF EXISTS "model_membership_levels" CASCADE`);
        await queryRunner.query(`DROP TABLE IF EXISTS "extension_feature" CASCADE`);
        await queryRunner.query(`DROP TABLE IF EXISTS "membership_plans" CASCADE`);
        await queryRunner.query(`DROP TABLE IF EXISTS "user_subscription" CASCADE`);
        await queryRunner.query(`DROP TABLE IF EXISTS "membership_order" CASCADE`);
        await queryRunner.query(`DROP TABLE IF EXISTS "membership_levels" CASCADE`);
        await queryRunner.query(
            `DROP TYPE IF EXISTS "public"."membership_plans_duration_config_enum"`,
        );
        ...
        await queryRunner.query(
            `CREATE INDEX "IDX_85ca9d6f4262a6bbff2a540c64" ON "membership_plans" ("id") `,
        );
        await queryRunner.query(`COMMENT ON TABLE "membership_plans" IS '订阅计划'`);
        await queryRunner.query(
            `CREATE TABLE "extension_feature" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "feature_code" character varying(128) NOT NULL, "name" character varying(100) NOT NULL, "description" text, "extension_id" uuid NOT NULL, "status" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_9b04a3a1f4fa6d7d7c0b713d8be" UNIQUE ("feature_code"), CONSTRAINT "PK_e1085a3a1ff815a4d56c7387742" PRIMARY KEY ("id")); COMMENT ON COLUMN "extension_feature"."feature_code" IS '功能唯一标识符'; COMMENT ON COLUMN "extension_feature"."name" IS '功能名称'; COMMENT ON COLUMN "extension_feature"."description" IS '功能描述'; COMMENT ON COLUMN "extension_feature"."extension_id" IS '关联的插件ID'; COMMENT ON COLUMN "extension_feature"."status" IS '功能状态'`,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_e1085a3a1ff815a4d56c738774" ON "extension_feature" ("id") `,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_9b04a3a1f4fa6d7d7c0b713d8b" ON "extension_feature" ("feature_code") `,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_3a8510aa093db5c036e46fd9c4" ON "extension_feature" ("extension_id") `,
        );
        await queryRunner.query(`COMMENT ON TABLE "extension_feature" IS '插件功能配置'`);
        await queryRunner.query(
            `CREATE TABLE "model_membership_levels" ("model_id" uuid NOT NULL, "level_id" uuid NOT NULL, CONSTRAINT "PK_622157d412014aa5319f0ca5f64" PRIMARY KEY ("model_id", "level_id"))`,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_9c3405d21ea8adaab3c3ea38c9" ON "model_membership_levels" ("model_id") `,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_4ce1671490d99b882efd63e557" ON "model_membership_levels" ("level_id") `,
        );
        await queryRunner.query(
            `CREATE TABLE "extension_feature_membership_levels" ("feature_id" uuid NOT NULL, "level_id" uuid NOT NULL, CONSTRAINT "PK_a340d98a9eccf80cfddfbb173b6" PRIMARY KEY ("feature_id", "level_id"))`,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_55989bb6234bf58156003f11f5" ON "extension_feature_membership_levels" ("feature_id") `,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_996bcaf0d89288971d3fd18d58" ON "extension_feature_membership_levels" ("level_id") `,
        );
        await queryRunner.query(
            `ALTER TABLE "ai_models" ADD "membership_level" jsonb NOT NULL DEFAULT '[]'`,
        );
        await queryRunner.query(`COMMENT ON COLUMN "ai_models"."membership_level" IS '会员等级'`);
        await queryRunner.query(`ALTER TABLE "extension" ADD "alias" character varying(100)`);
        await queryRunner.query(`COMMENT ON COLUMN "extension"."alias" IS '应用别名'`);
        await queryRunner.query(
            `ALTER TABLE "account_log" ADD "expire_at" TIMESTAMP WITH TIME ZONE`,
        );
        await queryRunner.query(`COMMENT ON COLUMN "account_log"."expire_at" IS '积分过期时间'`);
        await queryRunner.query(
            `ALTER TABLE "account_log" ADD "available_amount" integer NOT NULL DEFAULT '0'`,
        );
        await queryRunner.query(
            `COMMENT ON COLUMN "account_log"."available_amount" IS '当前记录剩余可用数量'`,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_a4080a4f503b11ad37c759f08d" ON "account_log" ("expire_at") `,
        );
        await queryRunner.query(
